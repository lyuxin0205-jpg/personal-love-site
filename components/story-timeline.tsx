        ...
        {timeline.map((item, index) => (
          ...
          >
            ...
            >
              ...
              <Link href={`/story?slug=${encodeURIComponent(item.slug)}`} className="block overflow-hidden bg-[#fffdf2] p-2 shadow-[0_18px_42px_rgba(39,79,75,.12)]">
            ...
            <div className="self-center border-l border-[#9dbbab]/32 pl-5 sm:pl-7">
              ...
              <div className="mb-4 flex max-w-[42rem] items-start gap-2">
                <Link href={`/story?slug=${encodeURIComponent(item.slug)}`} className="group/title min-w-0">
              ...
              <Link
                href={`/story?slug=${encodeURIComponent(item.slug)}`}
