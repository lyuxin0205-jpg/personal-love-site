...
export function CloudAlbum() {
  ...
  return (
    ...
    >
      ...
      <button className="inline-flex w-fit items-center justify-center gap-2 rounded-full border border-[#8fb5a3]/28 bg-[#fffdf1]/72 px-5 py-3 text-sm text-[#315f5a]/72 transition hover:bg-[#fffdf1] hover:text-[#244d49]">
